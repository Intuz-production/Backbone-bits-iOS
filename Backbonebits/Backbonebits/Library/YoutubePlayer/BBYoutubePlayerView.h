...
@class BBYoutubePlayerView;

/** These enums represent the state of the current video in the player. */
typedef NS_ENUM(NSInteger, YTPlayerState) {
    kBBYoutubePlayerStateUnstarted,
    kBBYoutubePlayerStateEnded,
    kBBYoutubePlayerStatePlaying,
    kBBYoutubePlayerStatePaused,
    kBBYoutubePlayerStateBuffering,
    kBBYoutubePlayerStateQueued,
    kBBYoutubePlayerStateUnknown
};

/** These enums represent the resolution of the currently loaded video. */
typedef NS_ENUM(NSInteger, YTPlaybackQuality) {
    kBBYoutubePlaybackQualitySmall,
    kBBYoutubePlaybackQualityMedium,
    kBBYoutubePlaybackQualityLarge,
    kBBYoutubePlaybackQualityHD720,
    kBBYoutubePlaybackQualityHD1080,
    kBBYoutubePlaybackQualityHighRes,
    kBBYoutubePlaybackQualityAuto, /** Addition for YouTube Live Events. */
    kBBYoutubePlaybackQualityDefault,
    kBBYoutubePlaybackQualityUnknown /** This should never be returned. It is here for future proofing. */
};

/** These enums represent error codes thrown by the player. */
typedef NS_ENUM(NSInteger, YTPlayerError) {
    kBBYoutubePlayerErrorInvalidParam,
    kBBYoutubePlayerErrorHTML5Error,
    kBBYoutubePlayerErrorVideoNotFound, // Functionally equivalent error codes 100 and
    // 105 have been collapsed into |kBBYoutubePlayerErrorVideoNotFound|.
    kBBYoutubePlayerErrorNotEmbeddable, // Functionally equivalent error codes 101 and
    // 150 have been collapsed into |kBBYoutubePlayerErrorNotEmbeddable|.
    kBBYoutubePlayerErrorUnknown
};
 ...
 */
- (void)playerView:(BBYoutubePlayerView *)playerView didChangeToState:(YTPlayerState)state;
 ...
 */
- (void)playerView:(BBYoutubePlayerView *)playerView didChangeToQuality:(YTPlaybackQuality)quality;
 ...
 */
- (void)playerView:(BBYoutubePlayerView *)playerView receivedError:(YTPlayerError)error;
 ...
 */
@interface BBYoutubePlayerView : UIView<UIWebViewDelegate>
